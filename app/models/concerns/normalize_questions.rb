module NormalizeQuestions
  extend ActiveSupport::Concern
    included do

      def normalize_params(questions)
        questions.one_speaker = questions.one_speaker.to_i
      end
      :, :two_show_defects, :three_exaustive_work, :four_sad,:five_original,
